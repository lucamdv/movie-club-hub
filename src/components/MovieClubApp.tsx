...
export default function MovieClubApp() {
  ...
  if (!authCtx.user)
    return (
      <>
        ...
        {pwa.showBanner && (
          <InstallBanner isIOS={pwa.isIOS} onInstall={pwa.triggerInstall} onDismiss={pwa.dismissBanner} />
        )}
      </>
    );
  ...
  return (
    <div style={{ minHeight: "100dvh", background: C.bg }}>
      <Navbar page={page} setPage={setPage} hasKeys={true} apiStatus={apiStatus} isMobile={isMobile} />
      ...
      <div className="app-content page-enter" key={page}>
        ...
        {page === "view-profile" && (
          <ProfilePage setPage={setPage} auth={authCtx} setSelectedMovie={setSM} viewUserId={viewProfileUserId} />
        )}
        {page === "movie" && (
          <MoviePage
        ...
        {page === "friends" && (
          <FriendsPage setPage={setPage} setSelectedMovie={setSM} auth={authCtx} onViewProfile={handleViewProfile} />
        )}
